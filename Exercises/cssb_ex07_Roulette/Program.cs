...
namespace Roulette
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Your winning nuber is: {0}", bin);
            Console.WriteLine("The winning bets based on your spin are: ");
            ...
            if (red.Contains(bin))
            {
                Console.WriteLine("Winning Color: Red");
            }
            else if (black.Contains(bin))
            {
                Console.WriteLine("Winning Color: Black");
            }

            if (bin <= 18)
            {
                Console.WriteLine("Winner is Lows");
            }
            else if (bin >= 19)
            {
                Console.WriteLine("Winner is Highs");
            }
            ...
            {
                Console.WriteLine("Columns: Winner is 1st Colum");
            ...
            {
                Console.WriteLine("Columns: Winner is 2nd Column");
            ...
            {
                Console.WriteLine("Columns: Winner is 3rd column");
